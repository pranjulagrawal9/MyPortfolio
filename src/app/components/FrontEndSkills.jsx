  ...
  return (
    ...
    >
      <ul className="flex flex-col gap-5">
        ...
        <li className="flex items-center">
          <div className="w-1/4 flex justify-center">
            <Image src={js} className="w-20 px-2" />
          </div>
          <div className="w-3/4">
            <div className="bg-black w-full h-5 rounded-md flex items-center">
              <motion.div
        ...
        <li className="flex items-center">
          <div className="w-1/4 flex justify-center">
            <Image src={react} className="w-20" />
          </div>
          <div className="w-3/4">
            <div className="bg-black w-full h-5 rounded-md flex items-center">
              <motion.div
        ...
        <li className="flex items-center">
          <div className="w-1/4 flex flex-col items-center">
            <Image src={redux} className="w-20" />
        ...
        <li className="flex items-center">
          <div className="w-1/4 flex justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              shapeRrendering="geometricPrecision"
              textRrendering="geometricPrecision"
